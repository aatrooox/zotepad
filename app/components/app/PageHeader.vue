...
<template>
  <div class="page-header px-4 md:px-8 pb-4 pt-[calc(1rem+env(safe-area-inset-top))] md:pb-6 md:pt-[calc(1.5rem+env(safe-area-inset-top))] flex items-center gap-3 sticky top-0 z-10 backdrop-blur-md">
